...
const Auth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{isLogin ? "Sign In" : "Sign Up"} AI Islam </title>
      ...
      <div className="min-h-screen bg-gradient-hero flex flex-col items-center justify-center p-4 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="font-display text-3xl text-primary">AI Islam</h1>
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-soft">
            ...
            <Button
              variant="outline"
              className="w-full mb-6 h-12 bg-white hover:bg-gray-50 border-gray-300 text-gray-700"
